...
namespace RawCMS.Plugins.Core
{
    ...
    public class CorePlugin : RawCMS.Library.Core.Extension.Plugin
    {
        ...
        private void EnsureDefaultApplication(CRUDService crudService)
        {
            ...
            {
                RawQuery = "{'CollectionName':'application'}"
            });
            ...
            if (schema.Items.Count == 0)
            {
                ...
                appSchema.FieldSettings = new List<Field>()
                {
                    new Field()
                    {
                        Name="Name",
            ...
            if (app.Items.Count == 0)
            {
                ...
                {
                    Name = "default",
                    Description = "Base application for internal logging",
                    PublicId = Guid.NewGuid()
                };
                crudService.Insert<Application>("application", defaultApp);
            }
        }
