  ...
  return {
    computed: {
      isSaveDisabled: function() {
        return (
          rawCmsDetailEditDef.computed.isSaveDisabled.call(this) ||
          !this.canSave
        );
      }
    },
...
const _CollectionItemDetailsDef = async () => {
  ...
  const tpl = await RawCMS.loadComponentTpl(
    "/app/modules/core/components/collection-item-details/collection-item-details.tpl.html"
  );
  ...
  return {
    ...
    computed: {
      ...
      isValid: function() {
        return optionalChain(() => this.formState.$valid, {
          fallbackValue: true
        });
      }
    },
