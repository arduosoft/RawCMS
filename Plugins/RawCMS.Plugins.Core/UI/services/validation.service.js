...
class ValidationService {
        ...
        text: {
            maxlength: maxLength => {
                return {
                    ...
                    message: RawCMS.vue.$t("core.validation.text.maxlength", {
                        maxLength: maxLength
                    })
                };
            }
    ...
    applyFieldMetadataToFormlyInput(
        ...
        const fieldsMetadata = optionalChain(
            () => vuexStore.state.core.fieldsMetadata,
            {
                fallbackValue: {},
        ...
        validators.forEach(x => {
            ...
            const option = optionalChain(() => fieldOptions[x.name], {
                fallbackValue: {}
            });
            ...
            formlyField.validators[key] = function (field, model, next) {
                ...
                const fnValidator = Function(
                    "{ item, errors, options, name, Type, value }",
                    x.function
                );
