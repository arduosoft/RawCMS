...
import { LambdasListDef } from "/app/modules/core/components/lambdas-list/lambdas-list.js";

const _LambdasListView = async (res, rej) => {
    const tpl = await RawCMS.loadComponentTpl(
        "/app/modules/core/views/lambdas-list-view/lambdas-list-view.tpl.html"
    );
